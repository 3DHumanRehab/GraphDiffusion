...
def parse_args():
    ...
    #########################################################
    # Loading/Saving checkpoints/HOME/HOME/Chenhaiwei/PointHMR_PIPS_TemporalFusion_2_copy5/src/tools/output_3dpw_NoisyTune_step8_reduce_ema_4
    #########################################################
    parser.add_argument("--output_dir", default='/HOME/HOME/Chenhaiwei/PointHMR_PIPS_TemporalFusion_2_copy5/src/output/output_all_H36_withoutloss', type=str, required=False,
