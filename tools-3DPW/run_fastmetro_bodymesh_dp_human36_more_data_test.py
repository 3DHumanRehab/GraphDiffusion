...
from src.modeling.model.modeling_fastmetro import FastMETRO_Body_Network as FastMETRO_Network
...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--output_dir", default='output_3dpw_step8_ema_back/', type=str, required=False,
