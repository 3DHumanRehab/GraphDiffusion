...
print("/HOME/Zhongzhangnan/FastMETRO_MEA_PIPS")
...
from src.modeling.model.modeling_fastmetro_EMA_4_S import FastMETRO_Body_Network as FastMETRO_Network
...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--output_dir", default='output_3dpw_step8_ema_back_pips_S_loss/', type=str, required=False,
