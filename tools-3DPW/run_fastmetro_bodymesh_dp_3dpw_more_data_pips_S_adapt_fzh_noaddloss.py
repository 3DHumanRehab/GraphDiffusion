...
def run_train(args, train_dataloader, val_dataloader, FastMETRO_model, smpl, mesh_sampler, renderer, smpl_intermediate_faces, smpl_intermediate_edges):    
    ...
    lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer.module, step_size=200,gamma=0.1)
...
def parse_args():
    ...
    parser.add_argument("--resume_checkpoint", default="/root/fengzehui/output_3dpw_step8_ema_back_S_adapt_loss_test/checkpoint-72-12672/state_dict.bin", type=str, required=False,
