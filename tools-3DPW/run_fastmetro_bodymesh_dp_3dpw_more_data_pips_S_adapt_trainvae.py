...
from src.modeling.model.modeling_fastmetro_EMA_4_S_adapt_train_trainvae import FastMETRO_Body_Network as FastMETRO_Network
...
def run_train(args, train_dataloader, val_dataloader, FastMETRO_model, smpl, mesh_sampler, renderer, smpl_intermediate_faces, smpl_intermediate_edges):    
    ...
    for _, (img_keys, images, annotations) in enumerate(train_dataloader):
        ...
        loss = vertices_loss(criterion_3d_vertices,out['reconstructed_x'], out['img_features'])
        '''new loss'''
...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--output_dir", default='vae_output/', type=str, required=False,
    ...
    parser.add_argument("--resume_checkpoint", default="/root/fengzehui/vae_output/checkpoint-0-0/state_dict.bin", type=str, required=False,
