...
def parse_args():
    ...
    parser.add_argument("--resume_checkpoint", default="/HOME/Zhongzhangnan/FastMETRO_MEA_PIPS/output_3dpw_step8_ema_back_newpips/checkpoint-0-0/state_dict.bin", type=str, required=False,
