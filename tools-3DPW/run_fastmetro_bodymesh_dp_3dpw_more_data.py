...
def parse_args():
    ...
    parser.add_argument("--resume_checkpoint", default="/HOME/Zhongzhangnan/FastMETRO_MEA_PIPS/output_3dpw_step8_ema_back_old/checkpoint-2-352/state_dict.bin", type=str, required=False,
