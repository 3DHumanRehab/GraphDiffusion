...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--image_file_or_path", default='/HOME/HOME/Zhongzhangnan/FastMETRO_EMA_adapt/demo/test1', type=str, 
                        help="test data")
    #########################################################
    ...
    parser.add_argument("--resume_checkpoint", default="/HOME/HOME/Zhongzhangnan/FastMETRO/models/fastmetro_checkpoint/FastMETRO-L-H64_smpl_3dpw_state_dict.bin", type=str, required=False,
