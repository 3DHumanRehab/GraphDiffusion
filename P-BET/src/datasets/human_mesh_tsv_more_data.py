...
class MeshTSVDataset(object):
    def __init__(self, img_file, label_file=None, hw_file=None,
        ...
        # for key in ["downtown_stairs_00"]:
        # for key in ["downtown_weeklyMarket_00"]:
        # for key in ["downtown_enterShop_00"]:
        # for key in ["downtown_windowShopping_00"]:
        # for key in ["outdoors_fencing_01"]:
        # for key in ["flat_packBags_00"]:
        #for key in ["outdoors_fencing_01"]:
