...
from src.modeling.model.modeling_fastmetro_EMA_4_pips import FastMETRO_Body_Network as FastMETRO_Network
...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--output_dir", default='output_3dpw_step8_ema_back_newpips/', type=str, required=False,
                        help="The output directory to save checkpoint and test results.")
    parser.add_argument("--saving_epochs", default=1, type=int)
    parser.add_argument("--resume_checkpoint", default="/HOME/Zhongzhangnan/FastMETRO_MEA_PIPS/output_3dpw_step8_ema_back_newpips/checkpoint-60-600/state_dict.bin", type=str, required=False,
