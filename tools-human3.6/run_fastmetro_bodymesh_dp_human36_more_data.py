...
from src.modeling.model.modeling_fastmetro_EMA_4 import FastMETRO_Body_Network as FastMETRO_Network
...
def run_train(args, train_dataloader, val_dataloader, FastMETRO_model, smpl, mesh_sampler, renderer, smpl_intermediate_faces, smpl_intermediate_edges):    
    ...
    for _, (img_keys, images, annotations) in enumerate(train_dataloader):
        ...
        #     checkpoint_dir = save_checkpoint(FastMETRO_model, args, epoch, iteration)
            checkpoint_dir = save_checkpoint(FastMETRO_model, args, optimizer, 0, 0)
...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--output_dir", default='output_human36_step8_ema_back/', type=str, required=False,
                        help="The output directory to save checkpoint and test results.")
    parser.add_argument("--saving_epochs", default=1, type=int)
    parser.add_argument("--resume_checkpoint", default="/HOME/Zhongzhangnan/FastMETRO_MEA_PIPS/models/fastmetro_checkpoint/FastMETRO-L-H64_smpl_h36m_state_dict.bin", type=str, required=False,
