...
from src.modeling.hrnet.hrnet_cls_net_featmaps_org import get_cls_net
            ...
            if args.run_eval_and_visualize:
                ...
                if args.use_smpl_param_regressor:
                    ...
                    visual_imgs = visualize_mesh(renderer,
                                                ...
                                                pred_3d_vertices_fine.detach(), 
                                                pred_cam.detach())
                save_path = "/HOME/HOME/Zhongzhangnan/FastMETRO_EMA_adapt/test_by_3dpw_fastmetro_outdoors_parcours_00"
                ...
                for ii in range(len(all_vis)):
                    ...
                    if is_main_process():
                        stamp = str(epoch) + '_' + str(iteration)
                        temp_fname = save_path + 'visual_' + stamp +"_"+'%05d'%ii+"_"+ '.png'
                        # if args.use_opendr_renderer:
                        #     visual_imgs[:,:,::-1] = visual_imgs[:,:,::-1]*255
                        cv2.imwrite(temp_fname, np.asarray(cat_image))
...
def visualize_mesh(renderer, images, pred_vertices, pred_cam):
    rend_imgs = []
    images = images.reshape(16* 8, 3, 224, 224)
...
def parse_args():
    ...
    parser.add_argument("--resume_checkpoint", default="/HOME/HOME/Zhongzhangnan/FastMETRO_EMA_adapt/models/fastmetro_checkpoint/FastMETRO-L-H64_smpl_3dpw_state_dict.bin", type=str, required=False,
