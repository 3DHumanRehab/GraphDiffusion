...
from src.modeling.hrnet.hrnet_cls_net_featmaps_adapt_cat import get_cls_net
...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--output_dir", default='/HOME/Zhongzhangnan/FastMETRO_EMA_adapt/output_human36_step8_ema_back_S_adapt_cat_loss', type=str, required=False,
