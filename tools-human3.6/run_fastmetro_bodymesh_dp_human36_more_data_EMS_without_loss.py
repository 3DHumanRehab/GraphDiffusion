...
sys.path.append("/HOME/Zhongzhangnan/FastMETRO_EMA_adapt")


from src.tools.loss_change import calc_loss_SingleMesh_2D3DVelocity_changeWeight_no_heatmap,mean_velocity_error_train_2
from src.modeling.model.modeling_fastmetro_EMA_4_S_EMS import FastMETRO_Body_Network as FastMETRO_Network
from src.modeling._smpl import SMPL, Mesh
from src.modeling.hrnet.hrnet_cls_net_featmaps_EMS import get_cls_net
...
def parse_args():
    ...
    parser.add_argument("--train_yaml", default='/HOME/data/PointHMR/datasets/human3.6m/train.yaml', type=str, required=False,
                        help="Yaml file with all data for training.")
    parser.add_argument("--val_yaml", default='/HOME/data/PointHMR/datasets/human3.6m/valid.protocol2.yaml', type=str, required=False,
    ...
    #########################################################
    parser.add_argument("--output_dir", default='output_human36_step8_ema_back_S_EMS_withoutloss/', type=str, required=False,
                        help="The output directory to save checkpoint and test results.")
    parser.add_argument("--saving_epochs", default=1, type=int)
    parser.add_argument("--resume_checkpoint", default="/HOME/Zhongzhangnan/FastMETRO_EMA_adapt/models/fastmetro_checkpoint/FastMETRO-L-H64_smpl_h36m_state_dict.bin", type=str, required=False,
