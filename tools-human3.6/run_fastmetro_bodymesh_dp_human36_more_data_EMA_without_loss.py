...
sys.path.append("/HOME/HOME/Zhongzhangnan/FastMETRO_MEA_PIPS")
# print("/HOME/Zhongzhangnan/FastMETRO_MEA_PIPS")
for path in sys.path:
    print(path)
# print(os.listdir("/HOME/HOME/Zhongzhangnan/FastMETRO_MEA_PIPS"))
...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--output_dir", default='output5_3dpw_EMA_without_loss/', type=str, required=False,
